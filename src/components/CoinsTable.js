...
import { commas } from './Banner/Carousel';
...
<ThemeProvider theme={darkTheme}>
    <Container style={{ textAlign: "center" }}>
     <Typography 
          ...
          > CryptoCoins prices in market by GeekoCoins
</Typography>
<TextField label="Type here to find what u want..." variant="outlined"
style={{ marginBottom: 20, width: "100%"}}
onChange={(e) => setSearch(e.target.value)}
/>
<TableContainer>
  {loading ? (
      <LinearProgress style={{ backgroundColor: "#ea822b"}} />
  ) : (
      <Table >
        <TableHead style={{ backgroundColor: "#ea822b"}}>
<TableRow>
...
<TableCell component="th"  scope="row"
                        ...
                        <TableCell align="right">
                          {symbol}{" "}
                          {commas(row.current_price.toFixed(2))}
                        </TableCell>
                        <TableCell
                          align="right"
                          style={{
